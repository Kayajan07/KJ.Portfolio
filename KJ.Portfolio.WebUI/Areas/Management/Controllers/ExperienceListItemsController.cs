...
namespace KJ.Portfolio.WebUI.Areas.Management.Controllers
{
    ...
    public class ExperienceListItemsController : Controller
    {
        private readonly PortfolioDbContext _context;
        private readonly IWebHostEnvironment _env;

        public ExperienceListItemsController(PortfolioDbContext context, IWebHostEnvironment env)
        {
            _context = context;
            _env = env;
        }
        ...
        public async Task<IActionResult> Create(ExperienceListItem model, IFormFile? img)
        {
        ...
        [HttpPost, ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(ExperienceListItem model, IFormFile? img)
        {
            if (ModelState.IsValid)
            {
                if(img is not null)
                ...
                _context.ExperienceListItems.Update(model);
                await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            ...
            _context.ExperienceListItems.Remove(member);
            await _context.SaveChangesAsync();
